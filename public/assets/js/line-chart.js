$(document).ready(function(){
    $.ajax({
        url : window.location.origin + '/api/admin/getchart',
        type : "GET",
        success: function(res){
            ...
            if ($('#verview-shart').length) {
                var myConfig = {
                    ...
                    "scale-x": { //X-Axis
                        "labels": [res.Sunday[1], res.Monday[1], res.Tuesday[1], res.Wednesday[1], res.Thursday[1], res.Friday[1], res.Saturday[1]],
                        "label": {
                            "font-size": 14,
                            "offset-x": 0,
                        },
